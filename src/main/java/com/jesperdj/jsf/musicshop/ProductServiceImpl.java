...
public class ProductServiceImpl implements ProductService {
    ...
    public ProductServiceImpl() {
        ...
        map.put(1L, new Product(1L, "Microphone", "bdessamad for every vocalist - this microphone makes your voice sound great. Suitable for any kind of music and any voice.", new BigDecimal("95.00"), "microphone"));
